...
</code></pre>`,124),E=[m],g=o({__name:"js规范",setup(t,{expose:n}){return n({frontmatter:{},excerpt:void 0}),(p,s)=>(a(),e("div",d,E))}}),B={__name:"js",setup(t){return(n,p)=>{const s=r;return a(),l(s,null,{default:u(()=>[k(i(g),{id:"markdown"})]),_:1})}}};export{B as default};
