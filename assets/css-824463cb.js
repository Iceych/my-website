...
<span class="token punctuation">}</span>
</code></pre>`,36),m=[g],h=o({__name:"css规范",setup(p,{expose:n}){return n({frontmatter:{},excerpt:void 0}),(t,s)=>(a(),e("div",d,m))}}),y={__name:"css",setup(p){return(n,t)=>{const s=r;return a(),l(s,null,{default:u(()=>[i(k(h),{id:"markdown"})]),_:1})}}};export{y as default};
